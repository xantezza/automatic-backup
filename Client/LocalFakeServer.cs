...
namespace Client
{
    internal class LocalFakeServer
    {
        ...
        public void ProcessFormatedData(byte[] incomeData, Config config)
        {
            var isTheArrayAChunk = incomeData[incomeData.Length - 1] == 1;
            ...
            else
            {
                ...
                var newFilePath = filePathString.Replace(filePathString.Substring(0, 2), config.BackUpPath);
